            ...
            <div class="row">
                <div class="col-xl-9 col-lg-9 col-sm-12 col-xs-12 shop-content-right">
                    <div class="right-product-box">
                        ...
                        <div style="background-color:rgb(0,0,0,.1); height:30%; width:280px; ">
                            ...
                            <li><a href="shop.php?category=Fresco">Fresco</a></li>
                                <ul style="list-style:none;"><li style="margin-left:2em;"><a href="shop.php?category=Fresco&sub=Fruta"  style="color:black;">Fruta</a></li></ul>
                                <ul style="list-style:none;"><li style="margin-left:2em;"><a href="shop.php?category=Fresco&sub=Verdura"  style="color:black;">Verdura</a></li></ul> 
                         </ul>
                    </div>
                </div>
            </div>
