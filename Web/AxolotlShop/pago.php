            ...
            <div class="jumbotron text-center" style="background-color:#d6d6d6;">
                ...
                <div class="jumbotron" style="font-size:20px;font-weight:bold;">
                    <div style="align:center;">
                        ...
                        <a href="recibo.php" style="cursor:pointer;"><img src="img/visa.png" style="height:100px; width:150px;margin:20px;"></img></a>  
                        <a href="recibo.php" style="cursor:pointer;"><img src="img/paypal.jpg" style="height:100px; width:150px;margin:20px;"></img></a>
                        <a href="recibo.php" style="cursor:pointer;"><img src="img/mastercard.png" style="height:100px; width:150px;margin:20px;"></img></a>
                    </div>
                </div>
            </div>
        </article>
